...
const defaultImage = "/static/site.png";

export default ({ title, description, url, pageImage = defaultImage }) => (
  <Head>
    <title>{title}</title>
    ...
    <meta property="twitter:image:src" content={`${siteUrl}${pageImage}`} />
    ...
    <meta itemProp="image" content={`${siteUrl}${pageImage}`} />
