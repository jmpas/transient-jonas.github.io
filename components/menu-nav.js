...
export default ({ show, onChange, startTransition, closeMenu }) => (
  <nav className={ `menu-nav ${ show ? 'visible' : '' }` }>
    <ul>
      <MenuItem onHover={ onChange } slug='blog' href='/blog' middleware={ startTransition } sameRouteFallback={ closeMenu }>Articles</MenuItem>
      ...
      <MenuItem onHover={ onChange } slug='experiment' modifier='wip'>Experiments</MenuItem>
